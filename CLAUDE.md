# astro-blog Development Guidelines
...
# Add commands for Node.js (latest LTS recommended, minimum Node 18+)

## Code Style

Node.js (latest LTS recommended, minimum Node 18+): Follow standard conventions
