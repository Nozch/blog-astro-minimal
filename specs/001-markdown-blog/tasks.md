...
## Phase 3: User Story 1 - Write and Publish a Blog Post (Priority: P1) 🎯 MVP
...
- [ ] T044 Verify accessibility: Run Lighthouse audit, confirm WCAG AA contrast ratios, semantic HTML, score ≥90 (SC-007, FR-012)
...
- **User Stories (Phase 3-6)**: All depend on Foundational phase completion
  - After Phase 2, user stories are implemented incrementally in priority order (P1 → P2 → P3 → P4)
...
1. Complete Setup + Foundational → Minimal foundation ready
2. Add User Story 1 → Test incrementally → Deploy/Demo (MVP! Writers can publish posts with explicit slugs)
3. Add User Story 2 → Test incrementally → Deploy/Demo (Readers can navigate posts)
4. Add User Story 3 → Test incrementally → Deploy/Demo (Reading experience optimized with typography, dark mode, responsive)
5. Add User Story 4 → Test incrementally → Deploy/Demo (Tag organization complete)
...
- ✅ T019 (renumbered from T020): Slug validation updated to validate provided slugs only
- ✅ Notes section: Explicit MVP slug policy documented
